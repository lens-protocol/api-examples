...
export type Query = {
  ...
  doesFollow: OptimisticStatusResult;
...
export type DoesFollowQuery = { __typename?: 'Query', doesFollow: { __typename?: 'OptimisticStatusResult', value: boolean, isFinalisedOnchain: boolean } };

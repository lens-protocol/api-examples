...
export type AccessCondition = AndCondition | CollectCondition | ContractCondition | EoaOwnershipCondition | Erc20OwnershipCondition | FollowCondition | NftOwnershipCondition | OrCondition | ProfileOwnershipCondition;
...
/** Condition that checks if a contract function returns true. It only supports view functions that take at least an EvmAddress as param and returns a single boolean output */
export type ContractCondition = {
  __typename?: 'ContractCondition';
  /** ABI encoded function parameters. Has to be in human readable single string format containing the ABI of the function you want to call. See https://docs.ethers.org/v5/api/utils/abi/fragments/#human-readable-abi for more info */
  abi: Scalars['String'];
  address: Scalars['EvmAddress'];
  chainId: Scalars['ChainId'];
  functionName: Scalars['String'];
  /** ABI encoded function parameters. T */
